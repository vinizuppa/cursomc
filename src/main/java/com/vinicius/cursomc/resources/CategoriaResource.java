...
public class CategoriaResource {
	...
	public ResponseEntity<List<CategoriaDTO>> findAll() {
		...
		List<CategoriaDTO> listDto = list.stream().map(obj -> new CategoriaDTO(obj)).collect(Collectors.toList()); // Percorrer a lista, efetua uma operação para cada elemento da lista, transforma o stream para lista.
		//Retornando que a operação ocorreu com sucesso, retornando o objeto obj que criamos.
